...
INSERT INTO "new_Bundle" ("accentColor", "createdAt", "description", "id", "itemSubtextTemplate", "pricingType", "pricingValue", "shop", "shopifyProductId", "showPrices", "showSubtextOnGifts", "status", "title", "type", "updatedAt", "widgetHeading", "widgetStyle") SELECT "accentColor", "createdAt", "description", "id", "itemSubtextTemplate", "pricingType", "pricingValue", "shop", "shopifyProductId", "showPrices", "showSubtextOnGifts", "status", "title", "type", "updatedAt", "widgetHeading", "widgetStyle" FROM "Bundle";
DROP TABLE "Bundle";
