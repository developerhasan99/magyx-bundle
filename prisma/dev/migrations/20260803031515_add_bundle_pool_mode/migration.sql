...
CREATE TABLE "new_Bundle" (
    ...
    "poolMode" TEXT NOT NULL DEFAULT 'PER_PACKAGE',
...
INSERT INTO "new_Bundle" ("accentColor", "autoCheckout", "createdAt", "description", "freeShipping", "id", "itemSubtextTemplate", "pricingType", "pricingValue", "quantityBreakScope", "shop", "shopifyProductId", "showPrices", "showSubtextOnGifts", "skipCart", "status", "title", "translations", "type", "updatedAt", "widgetHeading", "widgetStyle") SELECT "accentColor", "autoCheckout", "createdAt", "description", "freeShipping", "id", "itemSubtextTemplate", "pricingType", "pricingValue", "quantityBreakScope", "shop", "shopifyProductId", "showPrices", "showSubtextOnGifts", "skipCart", "status", "title", "translations", "type", "updatedAt", "widgetHeading", "widgetStyle" FROM "Bundle";
DROP TABLE "Bundle";
