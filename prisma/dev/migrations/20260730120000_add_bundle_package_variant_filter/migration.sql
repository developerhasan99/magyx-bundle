...
INSERT INTO "new_BundlePackage" ("id", "bundleId", "label", "badgeText", "badgeTone", "position", "pricingType", "pricingValue", "freeShipping", "shopifyVariantId", "poolSource", "slotCount", "collectionIds") SELECT "id", "bundleId", "label", "badgeText", "badgeTone", "position", "pricingType", "pricingValue", "freeShipping", "shopifyVariantId", "poolSource", "slotCount", "collectionIds" FROM "BundlePackage";
